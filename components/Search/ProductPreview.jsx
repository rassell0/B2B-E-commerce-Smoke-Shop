...
function toggleModal(){
  ...
  return (
    <TouchableOpacity onPress={toggleModal} style={[tw` rounded-2xl border-2 border-gray-600 h-66 my-4 w-46 items-center `]}>
        {modal && <ProductModal isFav={isFav} stars={4.5} toggleFav={toggleFav} data={data} visible={modal} onPress={toggleModal}/>}
...
<TouchableOpacity onPress={toggleFav} style={[tw`rounded-full py-1 px-1.3 border border-white`]}>
